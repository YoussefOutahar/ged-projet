...
const ProfileCard = ({ user }: ProfileCardProps) => {
    ...
    const handleUpdatePicture = () => {
        if (selectedFile) {
            ...
            axiosInstance.put(`${API_URL}/admin/utilisateur/${user.id}/update-profile-picture`, formData)
                .then(response => {
    ...
    const { profilePicture } = useConnectedUserStore();
    ...
    return (
        <div className="profilecard">
            ...
            <div className="profile-pic">
                <img src={profilePicture ?? '/user-avatar.png'} alt="ProfilePicture"
                    onError={(e: any) => {
