...
const Create: React.FC<AccessShareCreateAdminType> = ({ visible, onClose, add, showToast, list, service, t }) => {
    ...
    return (
        <Dialog visible={visible}  closeOnEscape style={{ width: '70vw' }} header={t("accessShare.tabPan")} modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
            <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
                <TabPanel header={t("accessShare.tabPan")}>
                    <div className="formgrid grid">
                        <div className="field col-6">
                            <label htmlFor="code">{t("accessShare.code")} <b className="font-italic"> ({t("document.uniqueFields")})</b> </label>
                        ...
                        <div className="field col-6">
                            <label htmlFor="libelle">{t("accessShare.libelle")} <b className="font-italic"> ({t("document.uniqueFields")})</b> </label>
