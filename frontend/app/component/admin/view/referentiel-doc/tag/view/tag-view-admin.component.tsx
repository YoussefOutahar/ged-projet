...
const View: React.FC<TagViewAdminType> = ({ visible, onClose, selectedItem, t }) => {
    ...
    return (
        <Dialog visible={visible}  closeOnEscape style={{ width: '70vw' }} header={t("tag.tabPan")} modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
            <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
                <TabPanel header={t("tag.tabPan")}>
                    <div className="formgrid grid">

                        <div className="field col-6">
                            <label htmlFor="code">{t("tag.code")} <b className="font-italic"> ({t("document.uniqueFields")})</b> </label>
                            <InputText id="code" value={selectedItem?.code} disabled />
                        </div>

                        <div className="field col-6">
                            <label htmlFor="libelle">{t("tag.libelle")} <b className="font-italic"> ({t("document.uniqueFields")})</b> </label>
