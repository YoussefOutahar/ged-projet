...
public class DateUtil {
    ...
    public static final String REVERT_DEFAULT_DATE_FORMAT = "yyyy-MM-dd";
    ...
    public static LocalDate stringToLocalDate(final String dateString){
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(REVERT_DEFAULT_DATE_FORMAT);
    ...
    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern(DATE_FORMAT_ENG);
