...
public class RoleServiceImpl  implements RoleService {
    ...
    @Override
    public List<User> findUsersByRole(String authority) {
        if(authority == null) return null;
        return roleDao.findByAuthority(authority).getUsers();
    }

    @Override
    public List<Permission> findPermissionsByRole(String authority) {
        if(authority == null) return null;
        return roleDao.findByAuthority(authority).getPermissions();
    }
}
