...
public class MinioController {
    ...
    public FichierDTO uploadWithPath(@RequestParam("file") MultipartFile file, @PathVariable String bucket, @RequestParam("path") String path, @RequestParam(value = "fileName", required = false, defaultValue = "file") String fileName) {
        return minIOService.uploadWithPath(file, bucket, path, fileName);
    }

    @PostMapping("/upload/file-structured/{bucket}")
    public FichierDTO upload(@RequestParam("file") MultipartFile file, @PathVariable String bucket, @RequestParam("superior") String superior, @RequestParam("entity") String entity, @RequestParam(value = "fileName", required = false, defaultValue = "file") String fileName) {
        return minIOService.upload(file, bucket, superior, entity, fileName);
    }
